      ...
      <div className="container services_container">
        <article className="service">
         ...
         <ul className="service_list">
          ...
          <li>
            <BiCheck className='service_list-icon'/>
            <p>Results IN: products that delight users with their effectiveness.</p>
          </li>
          <li>
            <BiCheck className='service_list-icon'/>
            <p>Visual touchpoint that allow users to interact with aproject.</p>
          </li>
        ...
        <article className="service">
         ...
         <ul className="service_list">
          <li>
            <BiCheck className='service_list-icon'/>
            <p>Create everything a users sees on a website or software product.</p>
          </li>
          <li>
            <BiCheck className='service_list-icon'/>
          ...
          <li>
            <BiCheck className='service_list-icon'/>
            <p>Write the code that makes a website function.</p>
          </li>
          <li>
            <BiCheck className='service_list-icon'/>
