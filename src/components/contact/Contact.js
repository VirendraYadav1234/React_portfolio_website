      ...
      <div className="container contact_container">
        <div className="contact_options">
          <article className="contact_option">
            ...
            <h4>Email</h4>
            <h5 className="set">virendrayaduwanshi47@gmail.com</h5>
            <a href="mailto:virendrayaduwanshi47@gmail.com" target='_blank'>Send a Mail</a>
          </article>
          <article className="contact_option">
            <RiMessengerLine className="contact_option-icon" />
            <h4>Messanger</h4>
            <h5 className="set">VirendraYadav</h5>
            <a href="https://www.facebook.com" target="_blank">Send a Message</a>
          </article>
          <article className="contact_option">
            <BsWhatsapp className="contact_option-icon" />
            <h4>WhatsApp</h4>
            <h5 className="set">+9516352367</h5>
            <a href="https://api.whatsapp.com/send?phone919516352367" target="_blank">Send a message</a>
          </article>
        </div>
