    ...
    <section id="about">
      ...
      <div className="container about_container">
        ...
        <div className="about_content">
          ...
          <div class="text">
            <br></br>I'm Virendra and I'm a <span>Software Engineer</span>
          </div>
          <p>
            Hello I'm a computer science of Engineering student who found his
            true passion in programming and development . I knew this is what I
            wanted to do with my life ! I love the combination of creative and
